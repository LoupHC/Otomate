...
//********************PINOUT**************************
#define ROLLUP1_OPENING_PIN   2    //connect this pin to the opening relay (west motor)
#define ROLLUP1_CLOSING_PIN   3    //connect this pin to the closing relay (west motor)
#define ROLLUP2_OPENING_PIN   0    //connect this pin to the opening relay (east motor)
#define ROLLUP2_CLOSING_PIN   1    //connect this pin to the closing relay (east motor)
#define DEVICE1_PIN           4    //connect this pin to the device1 relay
#define DEVICE2_PIN           6    //connect this pin to the device2 relay
#define DEVICE3_PIN           5    //connect this pin to the device3 relay
